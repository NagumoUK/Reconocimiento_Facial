    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        <header className="topbar">
          ...
          <div className="topbar-actions"><button className="icon-button" aria-label="Ayuda"><CircleHelp size={19} /></button><button className="icon-button notification-button" aria-label="Notificaciones"><Bell size={19} /><i /></button><div className="profile"><div className="profile-avatar">AM</div><div><b>Andrea M.</b><span>Administradora</span></div><ChevronDown size={15} /></div></div>
        </header>
